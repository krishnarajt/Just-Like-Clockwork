            ...
            <div className="flex items-center gap-2">
              ...
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content menu bg-base-100 rounded-box z-[50] w-40 p-2 shadow-lg border border-base-300">
                  <li><a onClick={() => exportAllSessionsCSV(sessions)}>CSV</a></li>
                  <li><a onClick={() => exportAllSessionsJSON(sessions)}>JSON</a></li>
                  <li><a onClick={() => exportAllSessionsPDF(sessions)}>PDF</a></li>
                </ul>
              </div>
